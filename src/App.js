...
function App() {
  ...
  const resetScoreHome = () => {
    setHomeScore(0)
  }

  const resetScoreAway = () => {
    setAwayScore(0)
  }
    ...
    <div className="container">
      ...
      <section className="buttons">
        ...
        <div className="resetButton">
          <button className="awayButtons__touchdown" onClick={resetScoreHome}>Reset Home</button>
          <button className="awayButtons__touchdown" onClick={resetScoreAway}>Reset Away</button>
        </div>
      </section>
    </div>
  );
